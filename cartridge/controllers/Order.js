...
server.post(
    ...
    function (req, res, next) {
        ...
        var registrationObj = {
            ...
            cpf: order.billingAddress.cpf,
            birthday: order.billingAddress.birthday,
                ...
                try {
                    Transaction.wrap(function () {
                        ...
                        if (!authenticatedCustomer) {
                            ...
                            newCustomerProfile.cpf = registrationData.cpf;
                            newCustomerProfile.birthday = registrationData.birthday;
